...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { cantidad: @producto.cantidad, descripcion: @producto.descripcion, id_categoria: @producto.id_categoria, imagen: @producto.imagen, nombre: @producto.nombre, precio: @producto.precio } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { cantidad: @producto.cantidad, descripcion: @producto.descripcion, id_categoria: @producto.id_categoria, imagen: @producto.imagen, nombre: @producto.nombre, precio: @producto.precio } }
